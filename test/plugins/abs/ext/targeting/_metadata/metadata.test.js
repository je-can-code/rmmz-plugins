...
describe('J-ABS-Targeting metadata (direct src import)', () =>
{
  beforeAll(async () =>
  {
    ...
    await import('../../../../../../src/plugins/abs/ext/targeting/_metadata/initialization.js');
  });
  ...
  describe('host version requirements', () =>
  {
    it('throws when J-Base does not satisfy the minimum required version', async () =>
    {
      ...
      // Act & Assert
      await expect(import('../../../../../../src/plugins/abs/ext/targeting/_metadata/initialization.js'))
...
describe('unconfigured parameters', () =>
  {
    it('falls back to its shipped defaults when the project never set any parameters', async () =>
    {
      ...
      const { default: Metadata } = await import(
        '../../../../../../src/plugins/abs/ext/targeting/_metadata/_pluginMetadata.js');
      ...
      // Act
      const metadata = new Metadata('J-ABS-Targeting-Unconfigured', '1.0.0');
      globalThis.PluginManager = previous;

      // Assert
      expect(metadata.reticleImage).toEqual('WindowArrow');
    });
  });
});
