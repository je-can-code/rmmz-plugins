...
describe('J-ABS-Metrics metadata (direct src import)', () =>
{
  ...
  describe('external configuration translation', () =>
  {
    [
      ...
      [ 'alliesDownedVariableId', 'alliesDowned' ],
      ...
      [ 'attacksEvadedByEnemiesVariableId', 'attacksEvadedByEnemies' ],
      ...
      [ 'numberOfGlancingBlowsVariableId', 'numberOfGlancingBlows' ],
      [ 'numberOfGuardedHitsVariableId', 'numberOfGuardedHits' ],
      [ 'attacksEvadedByPartyVariableId', 'attacksEvadedByParty' ],
      [ 'damagePreventedByGuardingVariableId', 'damagePreventedByGuarding' ],
      ...
      [ 'guardActivationsVariableId', 'guardActivations' ],
      [ 'toolUsageVariableId', 'toolUsage' ],
      [ 'usableItemUsageVariableId', 'usableItemUsage' ],
