//region plugins/abs/core/register-jabs-save-routes.test.js
import { describe, expect, it } from 'vitest';

import { installSaveRegistrationRealm } from '../../../setup/install-save-registration-realm.js';

describe('registerJabsSaveRoutes', () =>
{
  /**
  ...
  const importWithSaveExtension = async saveExtensionInstalled =>
  {
    ...
    await import('../../../../src/plugins/abs/core/registerJabsSaveRoutes.js');

    return SaveSectionRouter;
  };

  it('routes the abs namespace into its own section file when J-Base-Save is installed', async () =>
  {
    // Arrange
    // Act
    ...
    expect(SaveSectionRouter.routedNamespaces()
      .get('_abs')).toBe('systems/abs.json');
  });
...
//endregion plugins/abs/core/register-jabs-save-routes.test.js