//region plugins/pixel/ext/abs/_component/game-player-abs-bridge.test.js
...
describe('J-ABS-Pixelistics Game_Player bridge (direct src import)', () =>
{
  ...
  {
    // Arrange
    // built off the real prototype so the setter the source writes through is present.
...
//endregion plugins/pixel/ext/abs/_component/game-player-abs-bridge.test.js
