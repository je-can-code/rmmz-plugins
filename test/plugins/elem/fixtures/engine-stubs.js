...
/**
 * Stubs for {@link out/J-Elementalistics.js}: battler chain, base {@link Game_Enemy#elementRate}, actions, {$dataSystem}.
 *
 * @param {object} sandbox
 */
export function installElemEngineStubs(sandbox)
{
  ...
  sandbox.Game_Enemy.prototype.elementRate = function(elementId)
  {
    return 1;
  };
