//region plugins/cms/core/_models/cms-parameter.test.js
import { beforeAll, beforeEach, describe, expect, it, vi } from 'vitest';

describe('CmsParameter (direct src import)', () =>
{
  let CmsParameter;
  let fakeDefinition;
  ...
  beforeAll(async () =>
  {
    ...
    ({ default: CmsParameter } = await import('../../../../../src/plugins/cms/core/_models/CmsParameter.js'));
  });
  ...
  describe('constructor/refresh', () =>
  {
    ...
    {
      // Arrange/Act
      const parameter = new CmsParameter(100, 'atk');
    ...
    it('falls back to the raw key with default icon/color when the registry has no definition', () =>
    {
      ...
      // Act
      const parameter = new CmsParameter(100, 'unknown-key');
    ...
    {
      // Arrange/Act
      const parameter = new CmsParameter(50, 'atk');

      // Assert
      expect(parameter).toBeInstanceOf(CmsParameter);
  ...
  describe('usesStyledValue', () =>
  {
    ...
    it('returns false for regen-per-second formatted parameters', () =>
    {
      ...
      const parameter = new CmsParameter(100, 'hpRegen');
...
//endregion plugins/cms/core/_models/cms-parameter.test.js
