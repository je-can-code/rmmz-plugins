//region plugins/sks/core/register-skill-slots-save-routes.test.js
import { describe, expect, it } from 'vitest';

import { installSaveRegistrationRealm } from '../../../setup/install-save-registration-realm.js';

describe('registerSkillSlotsSaveRoutes', () =>
{
  /**
  ...
  const importWithSaveExtension = async saveExtensionInstalled =>
  {
    ...
    await import('../../../../src/plugins/sks/core/registerSkillSlotsSaveRoutes.js');

    return SaveSectionRouter;
  };

  it('routes the sks namespace into its own section file when J-Base-Save is installed', async () =>
  {
    // Arrange
    // Act
    ...
    expect(SaveSectionRouter.routedNamespaces()
      .get('_sks')).toBe('systems/sks.json');
  });
...
//endregion plugins/sks/core/register-skill-slots-save-routes.test.js