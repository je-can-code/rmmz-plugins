...
describe('ParameterDefinitionBuilder (direct src import)', () =>
{
  ...
  beforeAll(async () =>
  {
    ...
    ({ default: SdpParameterBinding } = await import('../../../../../src/plugins/_base/core/models/SdpParameterBinding.js'));
    ({ default: ParameterDefinition } = await import('../../../../../src/plugins/_base/core/models/ParameterDefinition.js'));
    ({ default: ParameterDefinitionBuilder } = await import('../../../../../src/plugins/_base/core/models/ParameterDefinitionBuilder.js'));
  });
