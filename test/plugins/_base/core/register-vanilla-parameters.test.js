...
describe('VanillaParameterRegistration (direct src import)', () =>
{
  ...
  beforeAll(async () =>
  {
    ...
    ({ default: ParameterGroups } = await import('../../../../src/plugins/_base/core/ParameterGroups.js'));
    ({ default: ParameterRegistry } = await import('../../../../src/plugins/_base/core/ParameterRegistry.js'));
    ({ default: VanillaParameterRegistration } = await import('../../../../src/plugins/_base/core/registerVanillaParameters.js'));
  });
