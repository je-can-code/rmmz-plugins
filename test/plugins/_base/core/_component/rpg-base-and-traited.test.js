...
describe('RPG_Base / RPG_Traited (direct src import)', () =>
{
  ...
  beforeAll(async () =>
  {
    ...
    ({ default: RPG_Traited } = await import('../../../../../src/plugins/_base/core/database/base/RPG_Traited.js'));
  });
  ...
  describe('RPG_Traited', () =>
  {
    ...
    describe('constructor', () =>
    {
      ...
      {
        // Arrange
        const { default: RPG_Trait } = await import('../../../../../src/plugins/_base/core/database/_data/RPG_Trait.js');
        const raw = buildRawItem({
          traits: [
