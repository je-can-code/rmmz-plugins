...
describe('save storage layer (direct src import)', () =>
{
  ...
  beforeAll(async () =>
  {
    ...
    ({ default: SaveManifest } = await import('../../../../../src/plugins/_base/core/save/SaveManifest.js'));
    ({ default: SaveFileSystem } = await import('../../../../../src/plugins/_base/managers/SaveFileSystem.js'));
    ({ default: SaveDocument } = await import('../../../../../src/plugins/_base/core/save/SaveDocument.js'));
    ({ default: SaveSectionRouter } = await import('../../../../../src/plugins/_base/core/save/SaveSectionRouter.js'));
  });
