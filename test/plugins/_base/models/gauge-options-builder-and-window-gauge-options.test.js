...
describe('GaugeOptionsBuilder / WindowGaugeOptions (direct src import)', () =>
{
  ...
  beforeAll(async () =>
  {
    ...
    ({ default: WindowGaugeOptions } = await import('../../../../src/plugins/_base/models/WindowGaugeOptions.js'));
    ({ default: GaugeOptionsBuilder } = await import('../../../../src/plugins/_base/models/GaugeOptionsBuilder.js'));
  });
