...
describe('WindowCommandBuilder / BuiltWindowCommand (direct src import)', () =>
{
  ...
  beforeAll(async () =>
  {
    ...
    ({ default: BuiltWindowCommand } = await import('../../../../src/plugins/_base/models/BuiltWindowCommand.js'));
    ({ default: WindowCommandBuilder } = await import('../../../../src/plugins/_base/models/WindowCommandBuilder.js'));
  });
