...
{
  /** @type {typeof import('../../../../src/plugins/_base/managers/InputDeviceTracker.js').default} */
  ...
  beforeAll(async () =>
  {
    ...
    InputDeviceTracker = (await import('../../../../src/plugins/_base/managers/InputDeviceTracker.js')).default;

    await import('../../../../src/plugins/_base/managers/Input.js');
  });
