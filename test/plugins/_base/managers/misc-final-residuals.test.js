...
describe('J-Base misc final residual coverage (direct src import)', () =>
{
  ...
  beforeAll(async () =>
  {
    ...
    await import('../../../../src/plugins/_base/managers/Graphics.js');
    await import('../../../../src/plugins/_base/managers/ImageManager.js');
    await import('../../../../src/plugins/_base/managers/SoundManager.js');
    await import('../../../../src/plugins/_base/core/Bitmap.js');

    ({ default: SerializableRegistry } = await import('../../../../src/plugins/_base/core/SerializableRegistry.js'));
    ({ default: J_Timer } = await import('../../../../src/plugins/_base/models/J_Timer.js'));
    ({ default: RPG_SoundEffect } = await import('../../../../src/plugins/_base/database/miscellaneous/RPG_SoundEffect.js'));
  });
  ...
  describe('registerJBaseSerializableModels', () =>
  {
    it('registers J_Timer in the SerializableRegistry', async () =>
    {
      ...
      // Act
      await import('../../../../src/plugins/_base/core/registerJBaseSerializableModels.js');
