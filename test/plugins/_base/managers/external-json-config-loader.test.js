...
describe('ExternalJsonConfigLoader (direct src import)', () =>
{
  ...
  beforeAll(async () =>
  {
    ...
    ({ default: ExternalJsonConfigLoaderOptions } = await import('../../../../src/plugins/_base/models/ExternalJsonConfigLoaderOptions.js'));
    ({ default: ExternalJsonConfigLoader } = await import('../../../../src/plugins/_base/managers/ExternalJsonConfigLoader.js'));
  });
