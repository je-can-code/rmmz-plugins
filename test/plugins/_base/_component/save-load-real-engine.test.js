...
describe('save and load through the real engine objects', () =>
{
  ...
  beforeAll(async () =>
  {
    ...
    await import('../../../../src/plugins/_base/core/save/SaveDocument.js');
    await import('../../../../src/plugins/_base/core/save/registerEngineSaveCodecs.js');
    ({ default: SaveFileSystem } = await import('../../../../src/plugins/_base/managers/SaveFileSystem.js'));
    await import('../../../../src/plugins/_base/managers/StorageManager.js');
