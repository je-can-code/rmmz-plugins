...
/**
 * Flips the bare `__PLUGIN_NAME__`/`__PLUGIN_VERSION__` globals to J-Message-Chatter's identity.
 * @param {object} [sandbox] Defaults to `globalThis`.
 */
export function setPluginContextToJMessageChatter(sandbox = globalThis)
{
  sandbox.__PLUGIN_NAME__ = 'J-Message-Chatter';
  sandbox.__PLUGIN_VERSION__ = '1.0.0';
}
