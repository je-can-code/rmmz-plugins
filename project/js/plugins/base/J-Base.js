...
* of the message. The name is passed as a plain string literal matching that ship's `PLUGIN_NAME`
* rather than read from `J.SOMETHING.Metadata.name`, because a diagnostic that needs the namespace
* to be intact is useless in exactly the situation where the namespace is what broke.
*
...
var Diagnostics = class Diagnostics {
	...
	* @param {string} pluginName The emitting plugin's name, matching its own `PLUGIN_NAME`.
