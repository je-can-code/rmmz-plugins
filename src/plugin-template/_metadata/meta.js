...
// PLUGIN_NAME → __PLUGIN_NAME__ in the ship via Vite define (J.__TEMPLATE__.Metadata).
...
export const PLUGIN_NAME = 'J-TEMPLATE';
export const PLUGIN_VERSION = '1.0.0';
export const PLUGIN_DESC_TAG = 'TEMPLATE';
//endregion ship-meta