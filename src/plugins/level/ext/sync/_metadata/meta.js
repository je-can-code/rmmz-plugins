...
// PLUGIN_NAME → __PLUGIN_NAME__ in the ship via Vite define (J.LEVEL.EXT.SYNC.Metadata).
...
export const PLUGIN_NAME = 'J-Level-Sync';
export const PLUGIN_VERSION = '1.1.0';
export const PLUGIN_DESC_TAG = 'LEVEL-SYNC';
//endregion ship-meta
