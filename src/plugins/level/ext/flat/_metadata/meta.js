...
// PLUGIN_NAME → __PLUGIN_NAME__ in the ship via Vite define (J.LEVEL.EXT.FLAT.Metadata).
...
export const PLUGIN_NAME = 'J-Level-Flat';
export const PLUGIN_VERSION = '1.0.1';
export const PLUGIN_DESC_TAG = 'LEVEL-FLAT';
//endregion ship-meta