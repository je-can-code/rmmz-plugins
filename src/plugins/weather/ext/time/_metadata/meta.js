...
// PLUGIN_NAME → __PLUGIN_NAME__ in the ship via Vite define (J.WEATHER.EXT.TIME.Metadata).
...
export const PLUGIN_NAME = 'J-Weather-Time';
export const PLUGIN_VERSION = '1.0.0';
export const PLUGIN_DESC_TAG = 'WEATHER-TIME';
//endregion ship-meta