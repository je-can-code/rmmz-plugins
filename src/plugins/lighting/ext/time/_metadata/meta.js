...
// PLUGIN_NAME → __PLUGIN_NAME__ in the ship via Vite define (J.LIGHTING.EXT.TIME.Metadata).
...
export const PLUGIN_NAME = 'J-Lighting-Time';
export const PLUGIN_VERSION = '1.0.0';
export const PLUGIN_DESC_TAG = 'LIGHTING-TIME';
//endregion ship-meta