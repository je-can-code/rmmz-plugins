  ...
  extends Window_Base
{
  ...
  drawTime()
  {
    ...
    // authored rather than fixed, because the other two rows take their icons from data and this
    // one silently becomes whatever happens to sit at its index once the icon sheet is moved.
