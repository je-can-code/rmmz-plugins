...
// PLUGIN_NAME → __PLUGIN_NAME__ in the ship via Vite define (J.ABS.EXT.METRICS.Metadata).
...
export const PLUGIN_NAME = 'J-ABS-Metrics';
export const PLUGIN_VERSION = '1.0.0';
export const PLUGIN_DESC_TAG = 'ABS-METRICS';
//endregion ship-meta