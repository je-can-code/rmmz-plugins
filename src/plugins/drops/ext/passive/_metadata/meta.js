...
// PLUGIN_NAME → __PLUGIN_NAME__ in the ship via Vite define (J.DROPS.EXT.PASSIVE.Metadata).
...
export const PLUGIN_NAME = 'J-Drops-Passive';
export const PLUGIN_VERSION = '1.0.0';
export const PLUGIN_DESC_TAG = 'DROPS-PASSIVE';
//endregion ship-meta