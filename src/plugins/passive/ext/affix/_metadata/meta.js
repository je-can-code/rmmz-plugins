...
// PLUGIN_NAME → __PLUGIN_NAME__ in the ship via Vite define (J.PASSIVE.EXT.AFFIX.Metadata).
...
export const PLUGIN_NAME = 'J-Passive-Affix';
export const PLUGIN_VERSION = '1.1.1';
export const PLUGIN_DESC_TAG = 'PASSIVE-AFFIX';
//endregion ship-meta