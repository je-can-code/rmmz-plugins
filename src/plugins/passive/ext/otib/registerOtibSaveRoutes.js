 ...
 * is what gives J-Passive-OTIB a file of its own to read.
 *
...
if (J.BASE.EXT.SAVE)
{
  SaveSectionRouter.registerNamespace('_otib', 'otib');
}
//endregion registerOtibSaveRoutes