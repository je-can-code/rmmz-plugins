...
// PLUGIN_NAME → __PLUGIN_NAME__ in the ship via Vite define (J.PASSIVE.EXT.ABS.Metadata).
...
export const PLUGIN_NAME = 'J-Passive-ABS';
export const PLUGIN_VERSION = '1.0.0';
export const PLUGIN_DESC_TAG = 'PASSIVE-ABS';
//endregion ship-meta