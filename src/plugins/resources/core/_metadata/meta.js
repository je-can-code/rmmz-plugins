...
// PLUGIN_NAME → __PLUGIN_NAME__ in the ship via Vite define (J.RESOURCES.Metadata).
...
export const PLUGIN_NAME = 'J-Resources';
export const PLUGIN_VERSION = '1.1.0';
export const PLUGIN_DESC_TAG = 'RESOURCES';
//endregion ship-meta