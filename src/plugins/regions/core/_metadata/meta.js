...
// PLUGIN_NAME → __PLUGIN_NAME__ in the ship via Vite define (J.REGIONS.Metadata).
...
export const PLUGIN_NAME = 'J-RegionEffects';
export const PLUGIN_VERSION = '1.2.0';
export const PLUGIN_DESC_TAG = 'REGIONS';
//endregion ship-meta