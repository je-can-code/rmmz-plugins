...
{
  // the logical position is the continuous one here, so it is kept as given.
  this.setX(x);
  this.setY(y);

  // and the render position is written to match, exactly as movement does every frame.
  this.setRealX(x);
  this.setRealY(y);
};
