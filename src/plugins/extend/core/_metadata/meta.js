...
// PLUGIN_NAME → __PLUGIN_NAME__ in the ship via Vite define (J.EXTEND.Metadata).
...
export const PLUGIN_NAME = 'J-Extend';
export const PLUGIN_VERSION = '1.7.3';
export const PLUGIN_DESC_TAG = 'EXTEND';
//endregion ship-meta