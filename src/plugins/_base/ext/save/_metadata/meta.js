...
// PLUGIN_NAME → __PLUGIN_NAME__ in the ship via Vite define (J.BASE.EXT.SAVE.Metadata).
...
export const PLUGIN_NAME = 'J-Base-Save';
export const PLUGIN_VERSION = '1.0.2';
export const PLUGIN_DESC_TAG = 'BASE-SAVE';
//endregion ship-meta
