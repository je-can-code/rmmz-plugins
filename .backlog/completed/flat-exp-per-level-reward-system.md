...
Shipped as **J-Level-Flat** (`src/plugins/level/ext/flat/`, built `project/js/plugins/level/ext/J-Level-Flat.js`): flat per-level EXP thresholds, map-based kill reward policy, and JABS integration through the Level stack. Further tuning and data migration remain game-side as needed.
