...
| [ally-ai-combo-actions-review](unstarted/ally-ai-combo-actions-review.md) | Low–medium | Medium polish / AI sanity (+juice if mis-inferred) | Ally swings/combos now readable — review weird lines; trace gauntlet-offhand vs guard-only builds and whether allies guard sanely. |
