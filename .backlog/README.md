...
| [editor-armors-board](unstarted/editor-armors-board.md) | Low–medium | **High** authoring throughput | `jmz-data-editor` Armors board (RMMZ-native parity): icon, atype, equip slot, price, params + MaxTP, traits, note. |
...
| [editor-items-board](unstarted/editor-items-board.md) | Low–medium | **High** authoring + dev-side | `jmz-data-editor` Items board; extracts shared Invocation/Damage/Effects from skills, then mounts with itype, consumable, scope/occasion. |
| [editor-ux-unification](unstarted/editor-ux-unification.md) | Medium | **High** breadth across whole editor | `jmz-data-editor` design-system pass: `<BoardSectionCard>` + normalized app-bar Save/Reload + per-board card migration (Crafting is the template), then a real Index dashboard. |
| [editor-weapons-board](unstarted/editor-weapons-board.md) | Low–medium | **High** authoring throughput | `jmz-data-editor` Weapons board (RMMZ-native parity): icon, wtype, animation, price, params + MaxTP, traits, note. |
