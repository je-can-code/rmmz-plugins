...
**Recent feature closures:** [`jafting-dynamic-row-identity.md`](completed/jafting-dynamic-row-identity.md), [`jafting-category-ingredients.md`](completed/jafting-category-ingredients.md),
