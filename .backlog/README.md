...
| [generic-skill-transform-resolution](unstarted/generic-skill-transform-resolution.md) | Medium–high design / runtime surface | **High** content flexibility | Generic `<skillTransform:[BASE, OVERRIDE]>` from note sources (actor/class/equips/states) with centralized resolved-skill layer for equipped slots. |
